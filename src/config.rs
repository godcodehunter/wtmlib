...
pub(crate) const WTMLIB_CALC_TSC_RANGE_ROUND_COUNT: i64 = 100;

/// A number of "round trips" that the current thread should make across
/// available CPUs when evaluating TSC monotonicity
pub(crate) const WTMLIB_EVAL_TSC_MONOTCTY_ROUND_COUNT: i64 = 100;
...
pub(crate) const WTMLIB_TSC_PROBE_WAIT_TIME: i64 = 300;
...
pub(crate) const WTMLIB_TSC_PROBE_COMPLETION_CHECK_PERIOD: i64 = 1;
...
pub(crate) const TMLIB_TSC_PROBE_WAIT_AFTER_CANCEL: i64 = 10;
...
pub(crate) const WTMLIB_TSC_DELTA_RANGE_COUNT_THRESHOLD: i64 = 10;
...
pub(crate) const WTMLIB_CALC_TSC_RANGE_PROBES_COUNT: i64 = 1000;
...
pub(crate) const WTMLIB_EVAL_TSC_MONOTCTY_PROBES_COUNT: usize = 1000;
...
pub(crate) const WTMLIB_FULL_LOOP_COUNT_THRESHOLD: i64 = 10;
...
pub(crate) const WTMLIB_TSC_PER_SEC_SAMPLE_COUNT: usize = 30;
...
/// into tsc-per-second
pub(crate) const WTMLIB_TIME_PERIOD_TO_MATCH_WITH_TSC: u64 = 500000;
...
pub(crate) const WTMLIB_TIME_CONVERSION_MODULUS: u64 = 10;